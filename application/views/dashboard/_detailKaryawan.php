                                            ...
                                            <div class="card-body">
                                                <form action="<?= base_url('Karyawan/store') ?>" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="lingkup" class="form-control" required>
                                                            <option value="staf" <?php if($tm->lingkup == 'staf'){echo 'selected';} ?>>Staf</option>
                                                            <option value="lapangan" <?php if($tm->lingkup == 'lapangan'){echo 'selected';} ?>>Lapangan</option>
                                                            <option value="kontrak" <?php if($tm->lingkup == 'kontrak'){echo 'selected';} ?>>Kontrak</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
