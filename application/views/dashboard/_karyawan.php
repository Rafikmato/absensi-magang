        ...
        <div id="layoutSidenav_content">            
            <main>
                <div class="container-fluid px-4">
                    ...
                    <a href="javascript:;" class="btn btn-success detail">Tambah Pegawai <i class="fas fa-user"></i></a>
                    <div class="mt-2">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="lingkup"  class="status form-control">
                                    <option value="">Pilih Detail Pekerjaan</option>
                                    <option value="staf">staf</option>
                                    <option value="lapangan">lapangan</option>
                                    <option value="kontrak">kontrak</option>
                                </select>
                                <div class="text-danger lingkup"></div>
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    <button name="save" type="submit" onclick="saved()" class="btn btn-success"><i class="fas fa-save"></i> Simpan</button>
        ...
        const saved = () => 
        {
            $.ajax({
                ...
                data:{
                    ...
                    lingkup:$('select[name=lingkup] option').filter(':selected').val(),
                },
                success: function (response) {
                    if(response.status == false)
                    {
                        var { nama,email,jkel,status,nik,password,konfirmasi,jabatan,lingkup } = response.msg;
                        $('.nik').html(nik);
                        $('.nama').html(nama);
                        $('.email').html(email);
                        ...
                        $('select[name=lingkup] option').filter(':selected').val(0),
                        // clean alert
                        $('.nik').html('');
                        $('.nama').html('');
                        $('.email').html('');
