                                    ...
                                    <table id="datatablesSimple">
                                        ...
                                        <?php $nomor = 0; foreach($data as $tm){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url("management-jabatan?edit={$tm->id_jabatan}") ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                    <a href="<?= base_url("hapus-jabatan/{$tm->id_jabatan}") ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>      
                                        <?php } ?>
                                        </tbody>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('Karyawan/storeJabatan') ?>" method="post">
                                        ...
                                        <button type="submit" name="edit" class="btn btn-warning mt-2">simpan</button>
                                        <a href="<?= base_url('management-jabatan') ?>" class="btn btn-danger mt-2">Kembali</a>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="<?= base_url('Karyawan/storeJabatan') ?>" method="post">
                                            ...
                                            <button type="submit" name="store" class="btn btn-success mt-2 w-100">simpan</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
