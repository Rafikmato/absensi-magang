...
class Admin extends CI_Controller
{
    ...
    public function store()
    {
        if(isset($_POST["time_1"]))
        {
            ...
            $this->session->set_flashdata('alert','<div class="alert alert-info">Waktu Absensi Berhasil di ubah</div>');
    ...
    public function delete_admin($id)
    {
        ...
        $this->session->set_flashdata('alert','<div class="alert alert-info">Berhasil menghapus operator</div>');
        return redirect('daftar-admin');
    }
