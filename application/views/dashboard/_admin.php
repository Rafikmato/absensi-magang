        ...
        <div id="layoutSidenav_content">            
            <main>
                <div class="container-fluid px-4">
                    ...
                    <a href="javascript:;" class="btn btn-success detail"><i class="fas fa-user"></i>   Tambah Admin </a>
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $rows->username ?></td>
                                        <td>
                                            <a href="<?= base_url('detail-admin/'.$rows->id) ?>" class="btn btn-info">Lihat</a>
                                            <a class="btn btn-danger" href="<?= base_url('hapus-admin/'.$rows->id)?>">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
