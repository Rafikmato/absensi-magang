        ...
        <div id="layoutSidenav_content">            
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Pengaturan Absensi</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Pengaturan Absensi</li>
                    </ol>
                    <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        Ketentuan Jam Datang dan Pulang
                                    </div>
                                    <form action="<?= base_url('Admin/store') ?>" method="post">
                                        <div class="card-body">
                                            ...
                                            <button name="time_1" class="btn btn-success mt-3 w-100">Simpan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <form action="<?= base_url('Admin/store') ?>" method="post">
                                        <div class="card-body">
                                            ...
                                            <button name="time_2" class="btn btn-success mt-3 w-100">Simpan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
